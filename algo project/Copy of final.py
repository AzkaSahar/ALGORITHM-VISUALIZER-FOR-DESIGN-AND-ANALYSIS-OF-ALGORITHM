...
class App(CTk):
    def __init__(self):
        ...
        # Style for buttons and labels to look like "alert" buttons
        button_style = {
            "fg_color": "black",
            "text_color": "#ff0000",
            "hover_color": "#990000",
        ...
        radio_button_style = {
            ...
            "text_color": "#ff0000",     
            "font": ("Consolas", 11, "bold")  # Modern font for the futuristic theme
        }
    ...
    def draw_empty_tree(self):
        ...
        fig.patch.set_facecolor("black")  # Ensure figure background is black
        ax.patch.set_facecolor("black")  # Ensure axis background is black
    ...
    def display_karatsuba_graph(self, G, nodesizes, products):
        ...
        self.after(2000, self.show_products, products)
    ...
    def show_products(self, products):
        ...
        text_color = "black"           # White text for visibility on red background
        ...
        for i, (num1, num2, product) in enumerate(products):
            ...
            ax.text(
                ...
                fontsize=font_size, color=text_color, bbox=dict(
                    ...
                    facecolor=product_box_color, edgecolor=border_color, linewidth=1.0  # Red box with white border
                ),
